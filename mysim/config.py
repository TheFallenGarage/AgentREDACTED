...
DONKEY_GYM = True
DONKEY_SIM_PATH = "/home/daniel/projects/DonkeySimLinux/donkey_sim.x86_64" # when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
